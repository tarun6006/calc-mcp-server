...
def main():
    """Run tests with coverage for Calculator MCP Server"""
    logger.info("Calculator MCP Server - Test Suite with Coverage")
    ...
    try:
            ...
            try:
                with open("coverage.json", 'r') as f:
                    ...
                    summary_report = {
                        ...
                        "application": "Calculator MCP Server",
        ...
        if result.returncode == 0:
            logger.info("Calculator MCP Server tests passed with sufficient coverage!")
            sys.exit(0)
        else:
            logger.error("Calculator MCP Server tests failed or coverage below 90%%!")
            sys.exit(1)
